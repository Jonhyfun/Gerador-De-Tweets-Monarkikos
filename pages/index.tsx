...
export default function Index({monarkisses}) {
  ...
  return (
    <div className="w-screen h-screen flex flex-col gap-10 justify-center items-center bg-blue-400">
      ...
      <p style={{width:'700px'}} className="text-white">Esta é apenas a primeira versão dessa aplicação. Os resultados podem variar por ser uma geração aleatória com poucos dados de base ainda. Você pode contribuir com tweets <a className="text-blue-700 underline" href="https://github.com/Jonhyfun/Gerador-De-Tweets-Monarkikos">aqui</a></p>
    </div>
  )
}